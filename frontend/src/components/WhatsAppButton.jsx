      ...
      {isOpen && (
        <div className="mb-2 sm:mb-3 w-[calc(100vw-2.5rem)] max-w-xs sm:w-72 bg-white rounded-2xl shadow-2xl border border-slate-100 p-4 animate-scaleUp">
          ...
          <a
            ...
            className="mt-3 w-full inline-flex items-center justify-center gap-2 py-2 px-3 bg-[#25D366] hover:bg-[#20ba59] text-white text-xs font-bold rounded-xl transition active:scale-95 shadow-md shadow-green-500/20"
          >
